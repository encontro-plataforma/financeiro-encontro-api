...
| `APP_VERSION` | Versão da aplicação exibida no startup e no health check | `0.2.0` | Não |
...
O valor padrão é `0.2.0`, mas pode ser sobrescrito por meio da variável `APP_VERSION`.
